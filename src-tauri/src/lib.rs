...
use commands::browser::{browser_close, browser_open, browser_set_position};
...
use commands::sessions::{
    ...
    get_password, has_password, group_master_change, group_master_create, group_master_status,
    group_master_verify, rdp_get_linux_clipboard, rdp_key_input, rdp_mouse_input, rdp_refresh_session,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            rdp_windows_reparent,
            rdp_windows_set_menu_region,
            show_rdp_tab_menu,
            // passwords
            save_password,
            get_password,
